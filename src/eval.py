...
def knn_eval(
    ...
    train_features = train_features.cpu() if train_features.is_cuda else train_features
    ...
    test_features = test_features.cpu() if test_features.is_cuda else test_features
    test_labels = test_labels.cpu() if test_labels.is_cuda else test_labels
