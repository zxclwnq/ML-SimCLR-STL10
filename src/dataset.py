...
def get_stl10_dataloader(
    ...
    Args:
        ...
        shuffle (bool): Whether to shuffle data. Should be False for evaluation splits.
        drop_last (bool): Whether to drop the last incomplete batch. Essential for training with contrastive loss.
