...
def main(config_path: str, simclr_path: str, method: str) -> None:
    ...
    try:
        ...
        print(f"[!] Error: Checkpoint file not found at {simclr_path}")
        return
    ...
    train_transform = T.Compose(
        [
            T.RandomResizedCrop(config["dataset"]["image_size"]),
